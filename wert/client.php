...
#{
$myHost = "rutyer.ru"; //адресс твоего сервера (доргена)
$pathOnMyHost = ""; //путь до папки на сервере (пусто, если Сервер не в папке) # /server/test
$pathToDor = "/wert"; //путь по которому будет доступен ваш дор-клиент (может быть виртуальная папка) # /mobile
$template = '!!!android_100914_out_46'; // шаблон дора
